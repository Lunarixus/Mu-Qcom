...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("gts7Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('gts7', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "gts7", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "gts7Pkg/gts7.dsc", "Platform Hardcoded")
